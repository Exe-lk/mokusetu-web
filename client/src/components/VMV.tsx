      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className={`floating-paper p-8 rounded-3xl text-center group hover:bg-gradient-to-r hover:from-primary hover:to-secondary transition-all duration-300 hover-lift ${sectionVisible ? 'slide-in-left visible' : 'slide-in-left'}`}>
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 group-hover:text-white transition-colors duration-300">Vision</h3>
          ...
          <div className={`floating-paper p-8 rounded-3xl text-center group hover:bg-gradient-to-r hover:from-secondary hover:to-success transition-all duration-300 hover-lift ${sectionVisible ? 'scale-in visible' : 'scale-in'}`} style={{ transitionDelay: '0.2s' }}>
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 group-hover:text-white transition-colors duration-300">Mission</h3>
            <p className="text-muted leading-relaxed group-hover:text-white transition-colors duration-300">
          ...
          <div className={`floating-paper p-8 rounded-3xl text-center group hover:bg-gradient-to-r hover:from-success hover:to-primary transition-all duration-300 hover-lift ${sectionVisible ? 'slide-in-right visible' : 'slide-in-right'}`} style={{ transitionDelay: '0.4s' }}>
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 group-hover:text-white transition-colors duration-300">Core Values</h3>
            <ul className="text-muted space-y-3 text-left group-hover:text-white transition-colors duration-300">
        ...
        <div className={`text-center mt-16 ${sectionVisible ? 'fade-in visible' : 'fade-in'}`} style={{ transitionDelay: '0.6s' }}>
          <div className="floating-paper p-8 rounded-3xl max-w-4xl mx-auto group hover:bg-gradient-to-r hover:from-primary hover:to-secondary transition-all duration-300">
            <h3 className="text-2xl font-bold text-foreground mb-4 group-hover:text-white transition-colors duration-300">Ready to Start Your Journey?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                href="/vision-mission" 
                className="inline-flex items-center gap-3 px-6 py-3 bg-white border border-secondary/20 text-secondary hover:bg-secondary/5 hover:border-secondary/30 rounded-xl transition-all duration-300 font-medium group hover:scale-105 shadow-sm hover:shadow-md"
              >
