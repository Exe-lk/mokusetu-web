    ...
    <section id="vmv" className="section section-secondary" ref={sectionRef}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className={`floating-paper p-8 rounded-3xl text-center group hover-lift ${sectionVisible ? 'slide-in-left visible' : 'slide-in-left'}`}>
          ...
          <div className={`floating-paper p-8 rounded-3xl text-center group hover-lift ${sectionVisible ? 'scale-in visible' : 'scale-in'}`} style={{ transitionDelay: '0.2s' }}>
            <div className="icon-container-unique w-20 h-20 mx-auto mb-6">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`floating-paper p-8 rounded-3xl text-center group hover-lift ${sectionVisible ? 'slide-in-right visible' : 'slide-in-right'}`} style={{ transitionDelay: '0.4s' }}>
            <div className="icon-container-unique w-20 h-20 mx-auto mb-6">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
